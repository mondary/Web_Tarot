...
const CARDS_DIR = path.join(WEBSITE_DIR, 'assets', 'img', 'cards');
const IMG_PREFIX = 'assets/img/cards/';
...
const SOURCE_DIR = path.join(WEBSITE_DIR, 'assets', 'md');
...
fs.writeFileSync(path.join(WEBSITE_DIR, 'assets', 'js', 'data.js'), out);
