...
function renderPortrait(md,answer=''){
  ...
  if(key)html+='<div class="prt-keyline"><span class="prt-key-badge">'+escapeHtml(key)+'</span></div>';
  if(answer)html+='<div class="prt-answer">'+escapeHtml(answer)+'</div>';
