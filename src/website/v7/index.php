...
$css .= '.d-hero{position:relative;overflow:hidden}.d-hero-loupe{position:absolute;width:200px;height:200px;border-radius:50%;background:radial-gradient(circle,rgba(201,162,39,.1),transparent 65%);border:1.5px solid rgba(201,162,39,.25);transform:translate(-50%,-50%);pointer-events:none;opacity:0;transition:opacity .35s ease-out;z-index:5;box-shadow:0 0 40px rgba(201,162,39,.08),inset 0 0 25px rgba(201,162,39,.04)}.d-hero-loupe.active{opacity:1}@media(hover:none){.d-hero-loupe{display:none}}';
$css .= '.portrait.card-of-day{margin:1.7rem 0 2.4rem}.portrait .card-of-day-label{gap:.5rem}.portrait .card-of-day-label .portrait-label-icon{display:inline-flex;width:1rem;height:1rem;color:var(--ac)}.portrait .card-of-day-label svg{width:100%;height:100%;stroke:currentColor}.portrait-content{padding-top:1.2rem}.portrait .prt-keyline{display:flex;justify-content:space-between;align-items:center;gap:1rem;margin:0 0 .85rem;padding-bottom:.5rem;border-bottom:2px solid var(--ac)}.portrait .prt-key-badge{font-family:"Cormorant Garamond",serif;font-size:clamp(2rem,5vw,3rem);font-weight:500;letter-spacing:.04em;line-height:.95;color:var(--ac);text-transform:uppercase}.portrait .prt-answer{flex:0 0 auto;font-family:"DM Mono",monospace;font-size:.72rem;font-weight:700;letter-spacing:.12em;padding:.4rem .8rem;border-radius:50px;text-transform:uppercase}.prt-answer.ans-oui{background:rgba(102,187,106,.12);color:#81c784;border:1px solid rgba(102,187,106,.35)}.prt-answer.ans-non{background:rgba(239,83,80,.12);color:#e57373;border:1px solid rgba(239,83,80,.35)}.prt-answer.ans-pas-encore{background:rgba(255,167,38,.12);color:#ffb74d;border:1px solid rgba(255,167,38,.35)}.prt-answer.ans-peut-etre{background:rgba(201,162,39,.12);color:var(--ac);border:1px solid rgba(201,162,39,.35)}.portrait .prt-hero{display:grid;grid-template-columns:2.4rem minmax(0,1fr);gap:.85rem;align-items:start;margin:0}.portrait .prt-icon{display:flex;align-items:center;justify-content:center;width:2rem;height:2rem;border:1px solid rgba(201,162,39,.32);border-radius:50%;color:var(--ac);background:rgba(201,162,39,.07)}.portrait .prt-icon svg{width:1rem;height:1rem;fill:none;stroke:currentColor;stroke-width:1.6;stroke-linecap:round;stroke-linejoin:round}.portrait .prt-idee{font-family:"Cormorant Garamond",serif;font-size:clamp(1.9rem,4.7vw,2.7rem);font-style:italic;font-weight:400;line-height:1.06;color:var(--fg);margin:.1rem 0 0}.portrait .prt-row{display:grid;grid-template-columns:2.4rem minmax(0,1fr);gap:.85rem;align-items:start;margin-top:1rem}.portrait .prt-realite{font-family:"Plus Jakarta Sans",system-ui,sans-serif;font-size:.96rem;line-height:1.7;color:#e0d8ca;margin:.15rem 0 0;max-width:47rem}.portrait .prt-image{display:grid;gap:.35rem;list-style:none;margin:0;padding:0}.portrait .prt-img-pair{display:grid;grid-template-columns:1fr auto 1fr;gap:.7rem;align-items:baseline;padding:.3rem 0;border-bottom:1px solid rgba(241,237,228,.04)}.portrait .prt-img-pair:last-child{border-bottom:none}.portrait .prt-img-vis{font-family:"Plus Jakarta Sans",system-ui,sans-serif;font-size:.85rem;line-height:1.45;color:#c9c1b2;text-align:right}.portrait .prt-img-arrow{color:var(--ac);opacity:.35;font-size:.75rem;align-self:center}.portrait .prt-img-mean{font-family:"Plus Jakarta Sans",system-ui,sans-serif;font-size:.85rem;line-height:1.45;color:#d4ccba;font-style:italic}.portrait .prt-img-plain{font-family:"Plus Jakarta Sans",system-ui,sans-serif;font-size:.88rem;line-height:1.55;color:#c9c1b2;margin:0}.portrait .prt-cite{display:grid;grid-template-columns:2.4rem minmax(0,1fr);gap:.85rem;align-items:start;margin:1.25rem 0 0;padding-top:1rem;border-top:1px solid rgba(241,237,228,.12)}.portrait .prt-cite p{font-family:"Cormorant Garamond",serif;font-size:1.45rem;font-style:italic;line-height:1.28;color:var(--ac);margin:.1rem 0 0}@media(max-width:540px){.portrait-content{padding-top:1rem}.portrait .prt-key-badge{font-size:2.2rem}.portrait .prt-answer{font-size:.65rem;padding:.3rem .6rem}.portrait .prt-row,.portrait .prt-hero,.portrait .prt-cite{grid-template-columns:2rem minmax(0,1fr);gap:.65rem}.portrait .prt-icon{width:1.75rem;height:1.75rem}.portrait .prt-idee{font-size:2rem}.portrait .prt-realite{font-size:.96rem}.portrait .prt-img-pair{grid-template-columns:1fr;gap:.1rem}.portrait .prt-img-vis{text-align:left}.portrait .prt-img-arrow{display:none}.portrait .prt-cite p{font-size:1.3rem}}';
$css .= '#nuances{position:fixed;inset:0;background:rgba(5,5,5,.85);backdrop-filter:blur(8px);display:none;z-index:1000;overflow-y:auto}#nuances.open{display:flex}.nuances-sheet{background:var(--bg);max-width:780px;margin:auto;width:calc(100% - 2rem);max-height:90vh;overflow-y:auto;border:1px solid var(--line);border-radius:1rem;padding:1.8rem;position:relative}.nuances-top{display:flex;justify-content:space-between;align-items:center;margin-bottom:1.5rem}.nuances-title{font-family:"Cormorant Garamond",serif;font-size:1.8rem;color:var(--ac);font-weight:400}.nuances-body .nuc-cat{margin-bottom:1.6rem}.nuances-body .nuc-cat h3{font-family:"DM Mono",monospace;font-size:.7rem;letter-spacing:.16em;text-transform:uppercase;color:var(--fg);margin-bottom:.7rem;padding-bottom:.4rem;border-bottom:1px solid var(--line)}.nuances-body .nuc-cat ul{list-style:none;padding:0;margin:0}.nuances-body .nuc-cat li{display:flex;gap:.5rem;align-items:flex-start;padding:.36rem 0;border-bottom:1px solid rgba(241,237,228,.04)}.nuances-body .nuc-cat li:last-child{border-bottom:none}.nuc-thumb{flex:0 0 24px;width:24px;aspect-ratio:2/3;border-radius:2px;overflow:hidden;background:var(--mat);border:1px solid rgba(241,237,228,.1);cursor:pointer}.nuc-thumb:hover{border-color:var(--ac)}.nuc-thumb img{display:block;width:100%;height:100%;object-fit:contain}.nuc-text{flex:1;min-width:0;padding-top:.02rem;font-size:.84rem;line-height:1.45;color:#b8b0a2}.nuc-card{color:var(--fg);font-weight:500}.nuc-key{color:var(--ac);font-weight:600;letter-spacing:.03em}.nuc-desc{color:var(--muted)}';
...
<div class="d-stage" id="detail"><div class="back-btn" id="backBtn">← Retour</div><div class="d-hero"><img class="d-hero-img" id="heroImg" alt=""><div class="d-hero-loupe" id="heroLoupe"></div></div><div class="d-panel"><div class="d-panel-inner" id="dInner"></div></div><div class="d-loop" id="loopBar"></div></div>
...
function renderPortrait(md,answer=''){
  if(!md)return '';
  ...
  if(key||answer){
    const ansClass=answer==='OUI'?'ans-oui':answer==='NON'?'ans-non':answer==='PAS ENCORE'?'ans-pas-encore':'ans-peut-etre';
    html+='<div class="prt-keyline">';
    if(key)html+='<span class="prt-key-badge">'+escapeHtml(key)+'</span>';
    if(answer)html+='<span class="prt-answer '+ansClass+'">'+escapeHtml(answer)+'</span>';
    html+='</div>';
  }
  if(idee)html+='<div class="prt-hero"><span class="prt-icon">'+PORTRAIT_ICONS.idea+'</span><p class="prt-idee">'+escapeHtml(idee)+'</p></div>';
